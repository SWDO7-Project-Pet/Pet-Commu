		...
		<div class="row">
				...
				<form class="form" action="/member/setting" method="post" id="registrationForm" enctype="multipart/form-data">
					<div class="text-center">
						...
						<h6>파일을 선택해주세요. (선택하실 경우에 이미지가 나타남)</h6>
						<input type="file" name="uploadFile" id="inputImage" class="text-center center-block file-upload">
					</div>
							...
							<div class="form-group">
								<div class="col-xs-6">
									<label for="first_name"><h4>PASSWORD</h4></label> <input
										...
										id="memberPw" placeholder="PASSWORD" value="${sessionScope.pw }"
							...
							<div class="form-group">
								<div class="col-xs-6">
									<label for="last_name"><h4>NAME</h4></label> <input
										...
										id="memberNames" placeholder="NAME" value="${sessionScope.name }"
							...
							<div class="form-group">
								<div class="col-xs-6">
									<label for="phone"><h4>PHONE</h4></label> <input type="text"
										...
										placeholder="PHONE" value="${sessionScope.phone }"
							...
							<div class="form-group">
								<div class="col-xs-6">
									<label for="mobile"><h4>BIRTH</h4></label> <input type="text"
										class="form-control" name="memberBirth" id="memberBirth" value="${sessionScope.birth }"
										maxlength="10"
