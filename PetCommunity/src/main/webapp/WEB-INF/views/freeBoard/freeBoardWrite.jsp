...
<html>
    ...
    <div id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- 글 쓰기 타이틀 -->
                    <h1 class="h3 mb-2 text-gray-800">글 작성</h1>
                    
                    <form action="/freeBoard/freeBoardWrite" method="post" id="frm" enctype="multipart/form-data">
	          			<!-- 제목 입력 -->
		                <div class="input-group mb-3">
		                	<div class="input-group-prepend">
							    <span class="input-group-text" id="basic-addon1">제목</span>
							</div>
							<input type="text" name="freeBoardTitle" class="form-control" placeholder="제목을 입력하세요." aria-label="제목을 입력하세요." aria-describedby="basic-addon1">
						</div>
						...
						<!-- 썸머노트(본문) -->
					    <textarea id="summernote" name="freeBoardContent" class="summernote"></textarea>
					    		                 
		                 <div align="right">
						    <input type="submit" class="btn btn-primary" value="작성" id="save">
						    <input type="button" class="btn btn-secondary" value="취소" onclick="location.href='/freeBoard/freeBoardMain';">
						</div>
