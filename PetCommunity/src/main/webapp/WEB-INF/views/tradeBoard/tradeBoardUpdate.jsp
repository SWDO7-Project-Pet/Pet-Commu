...
<html>
	...
	<%@include file="/WEB-INF/views/menubar.jsp"%>
                ...
                <div class="container-fluid">
                    ...
                    <form action="/tradeBoard/tradeBoardUpdate" method="post" id="frm" enctype="multipart/form-data">
	          			<!-- 제목 입력 -->
		                <div class="input-group mb-3">
		                	<div class="input-group-prepend">
							    <span class="input-group-text" id="basic-addon1">제목</span>
							</div>
							<input type="text" name="tradeBoardTitle" class="form-control" placeholder="제목을 입력하세요." 
							aria-label="제목을 입력하세요." aria-describedby="basic-addon1" value="${tradeBoard.tradeBoardTitle }">
						</div>
						...
						<div class="mb-3">
						  ...
						  <input class="form-control" type="file" id="multiUploadFile2" name="multiUploadFile2" multiple>
						</div>
														
						<!-- 썸머노트(본문) -->
					    <textarea id="summernote" name="tradeBoardContent" class="summernote">${tradeBoard.tradeBoardContent }</textarea>
									    		                 
		                <div align="right">
						    <input type="submit" class="btn btn-primary" value="수정">
						    <input type="button" class="btn btn-secondary" value="취소" onclick="location.href='/tradeBoard/tradeBoardMain';">
						</div>
