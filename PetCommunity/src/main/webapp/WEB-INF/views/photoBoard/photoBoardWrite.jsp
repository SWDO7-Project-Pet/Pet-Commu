...
<%@include file="/WEB-INF/views/menubar.jsp"%>
			<div class="container-fluid">
                    <!-- 글 쓰기 타이틀 -->
                    <h1 class="h3 mb-2 text-gray-800">사진게시판 작성</h1>
                    
                    <form action="/photoBoard/photoBoardWrite" method="post" id="frm" enctype="multipart/form-data">
                      <!-- 제목 입력 -->
                      <div class="input-group mb-3">
                         <div class="input-group-prepend">
                         <span class="input-group-text" id="basic-addon1">제목</span>
                     </div>
                     <input type="text" name="photoBoardTitle" class="form-control" placeholder="제목을 입력하세요." aria-label="제목을 입력하세요." aria-describedby="basic-addon1">
                  </div>
                  ...
                  <!-- 썸머노트(본문) -->
                   <textarea id="summernote" name="photoBoardContent" class="summernote"></textarea>
