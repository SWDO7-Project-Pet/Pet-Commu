			...
			<ul
				...
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
						...
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="/freeBoard/freeBoardMain">자유게시판</a> 
							<a class="collapse-item" href="/photoBoard/photoBoardMain">사진 게시판</a>
						</div>
					</div></li>
				...
				<li class="nav-item"><a class="nav-link collapsed" href="#"
					...
					aria-expanded="true" aria-controls="collapseUtilities"> <i
						class="fa fa-desktop fa-wrench"></i> <span>정보</span>
				</a>
				...
				<li class="nav-item"><a class="nav-link" href="/tradeBoard/tradeBoardMain"> <i
						class="fa fa-shopping-cart"></i> <span>거래 게시판</span></a></li>
	
				<!-- Nav Item - Tables(2번째의 2 탭) -->
				<li class="nav-item"><a class="nav-link" href="#"> <i
						class="fa fa-users"></i> <span>공지사항</span></a></li>
			...
			<div id="content-wrapper" class="d-flex flex-column">
				...
				<div id="content">
					...
					<nav
						...
						action="/freeBoard/searchAllFreeBoard" method="get">
							<div class="input-group">
								<input type="text" class="form-control bg-light border-0 small"
									placeholder="검색어를 입력하세요" aria-label="Search"
									aria-describedby="basic-addon2" name="searchWord">
